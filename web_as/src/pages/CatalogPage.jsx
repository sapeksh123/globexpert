...
function CatalogItemDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4">
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-slate-200 bg-white p-4 shadow-2xl sm:p-5">
        ...
        <form onSubmit={onSubmit} className="mt-4 grid gap-3 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <button
              type="button"
              onClick={() => onChange("isActive", !value.isActive)}
            ...
            >
              <span
                className={`h-2.5 w-2.5 rounded-full ${value.isActive ? "bg-emerald-500" : "bg-slate-400"}`}
              />
  ...
  return (
    <section className="space-y-4">
      <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        <h3 className="text-base font-semibold text-slate-900 sm:text-lg">Catalog Management</h3>
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-2 xl:grid-cols-5">
          <input
            ...
            className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none xl:col-span-2"
          />
          ...
          <button
            ...
            className="w-full rounded-xl border border-slate-300 px-3 py-2 text-xs font-medium text-slate-600 sm:col-span-2 xl:col-span-1"
          >
            Clear Filters
          </button>
        </div>
      ...
      {previewItem ? (
        <div
          ...
          aria-modal="true"
        >
          <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-3 shadow-2xl sm:p-4">
            <div className="mb-3 flex items-center justify-between">
              <h4 className="text-sm font-semibold text-slate-900 sm:text-base">{previewItem.title} Image Preview</h4>
              <button
                type="button"
